...
-- Student 1 (SV001) - IT-K1
INSERT INTO points (student_id, subject_id, score, semester) VALUES
(1, 1, 85.5, '2024-Q1'),
(1, 2, 90.0, '2024-Q1'),
(1, 3, 78.5, '2024-Q2');

-- Student 2 (SV002) - IT-K2
INSERT INTO points (student_id, subject_id, score, semester) VALUES
(2, 1, 92.0, '2024-Q1'),
(2, 2, 88.5, '2024-Q1'),
(2, 4, 95.0, '2024-Q2');

-- Student 3 (SV003) - IT-K2
INSERT INTO points (student_id, subject_id, score, semester) VALUES
(3, 1, 76.0, '2024-Q1'),
(3, 3, 82.5, '2024-Q1'),
(3, 5, 80.0, '2024-Q2');

-- Student 4 (SV004) - BM-K1
INSERT INTO points (student_id, subject_id, score, semester) VALUES
(4, 2, 88.0, '2024-Q1'),
(4, 3, 85.5, '2024-Q1');

-- Student 5 (SV005) - EN-K1
INSERT INTO points (student_id, subject_id, score, semester) VALUES
(5, 2, 79.5, '2024-Q1'),
(5, 4, 86.0, '2024-Q1');
